...
TextView Amount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notify_b= (Button)findViewById(R.id.Notifybutton);
        ...
        notify_b.setOnClickListener(this);
        getData();
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Tag_Friends.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(Tag_Friends.this,s,Toast.LENGTH_LONG).show();
            }
